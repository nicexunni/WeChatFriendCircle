...
#import "LZInfoViewController.h"
#import "LZAboutViewController.h"



@interface LZTabBarControllerConfig ()<UITabBarControllerDelegate>
...
- (NSArray *)viewControllers {
    LZHomeViewController *homeViewController = [[LZHomeViewController alloc] init];
    UIViewController *firstNavigationController = [[LZBaseNavigationController alloc]
                                                   initWithRootViewController:homeViewController];
    
    LZInfoViewController *infoViewController = [[LZInfoViewController alloc] init];
    ...
    LZAboutViewController *aboutViewController = [[LZAboutViewController alloc] init];
